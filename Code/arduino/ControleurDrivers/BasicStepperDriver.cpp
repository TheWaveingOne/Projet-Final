...
void BasicStepperDriver::begin(float rpm, short microsteps) {
  ...
  /*
      if IS_CONNECTED(enable_pin){
          pinMode(enable_pin, OUTPUT);                  Enable me cause des problèmes et je ne l'utilise pas
          disable();
      }
  */
  this->rpm = rpm;
  //setMicrostep(microsteps);   DRV8834 l'override

  //     digitalWrite(enable_pin, enable_active_state); Enable me cause des problèmes et je ne l'utilise pas
